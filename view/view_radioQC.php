<div class='panel panel-default'>
	...
	<div class='panel-body'>
		...
		?>
			<label class='bg-<?php echo $this->isAnswer($i) ? 'success' : 'danger' ?> text-white'><input type='radio' <?php if($this->isset($i++)) echo 'checked'; ?> disabled><?php echo $variation; ?></label><br>
		<?php } ?>
	</div>
</div>
